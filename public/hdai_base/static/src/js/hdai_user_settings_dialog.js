...
export class HdaiUserSettingsDialog extends Component {
    static template = "hdai_base.UserSettingsDialog";
    ...
    async load() {
        try {
            ...
            console.error("hdai: loading user settings failed", error);
    ...
    deletePrompt(promptId) {
        ...
        this.dialog.add(ConfirmationDialog, {
            ...
            confirm: async () => {
                try {
                    await this.orm.unlink("hdai.prompt", [promptId]);
    ...
    async save() {
        ...
        this.isSaving = true;
        try {
            await this.orm.call("hdai.session", "action_save_user_settings", [
                {
            ...
            console.error("hdai: saving user settings failed", error);
            this.notification.add(
