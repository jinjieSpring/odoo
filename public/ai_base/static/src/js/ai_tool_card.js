 ...
 */
export class AiToolCard extends Component {
    static template = "ai_base.ToolCard";
    static props = {
        tool: Object,
    ...
    openWhitelist() {
        ...
        this.actionService.doAction(
            "ai_base.hdai_action_nlview_model",
            {
        ...
        this._confirm(
            ...
            async () => {
                ...
                try {
                    ...
                    console.error("ai_base: module install failed", error);
                    this.state.installing = false;
    ...
    async execute() {
        try {
            ...
            console.error("ai_base: tool execution failed", error);
            this.notification.add(
